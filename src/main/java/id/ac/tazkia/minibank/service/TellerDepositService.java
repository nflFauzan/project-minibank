...
public class TellerDepositService {

    private final RekeningRepository rekeningRepository;
    private final TransaksiRepository transaksiRepository;
    private final UserRepository userRepository;

    public record DepositResult(String nomorTransaksi, BigDecimal saldoBaru) {}

    @Transactional
    public DepositResult deposit(String nomorRekening,
                                 BigDecimal jumlah,
                                 String keterangan,
                                 String noReferensi,
                                 String usernameLogin) {

        if (jumlah == null) throw new IllegalArgumentException("Jumlah setoran wajib diisi.");
        if (jumlah.compareTo(BigDecimal.valueOf(10_000)) < 0) {
            throw new IllegalArgumentException("Minimal setoran adalah IDR 10.000.");
        }
    ...
    throw new IllegalStateException("Rekening tidak aktif, tidak bisa diproses.");
        ...
        String nomorTransaksi = "T1" + String.format("%06d", seq);
        ...
        // nama_rekening: nama_nasabah + " - " + produk (sesuai keputusan kamu)
        ...
        return new DepositResult(nomorTransaksi, saldoSesudah);
    }
